...
class IterativeProjectedGradientBaseAttack(Attack):
    ...
    @abstractmethod
    def _gradient(self, a, x, adv_x, class_, strict=True):
    ...
    def _run(self, a, binary_search,
             ...
             random_start, return_early, bb_step):
        ...
        if binary_search:
            ...
            return self._run_binary_search(
                ...
                random_start, targeted, class_, return_early, k=k, bb_step=bb_step)
        else:
            return self._run_one(
                a, epsilon, stepsize, iterations,
                random_start, targeted, class_, return_early, bb_step=bb_step)

    def _run_binary_search(self, a, epsilon, stepsize, iterations,
                           random_start, targeted, class_, return_early, k, bb_step):
        ...
        def try_epsilon(epsilon):
            ...
            return self._run_one(
                a, epsilon, stepsize, iterations,
                random_start, targeted, class_, return_early, bb_step)
    ...
    def _run_one(self, a, epsilon, stepsize, iterations,
                 random_start, targeted, class_, return_early, bb_step=15):
        min_, max_ = a.bounds()
        s = max_ - min_
        ...
        for _ in range(iterations):
            gradient = self._gradient(a, original, x, class_, strict=strict)
