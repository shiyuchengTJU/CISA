...
import sys, os
sys.path.append("../new_foolbox")


from new_foolbox.attacks.base import MinimizationAttack, raise_if_kwargs, get_criterion, get_is_adversarial
from new_foolbox.attacks.gradient_descent_base import (
    uniform_l1_n_balls,
    normalize_lp_norms,
    uniform_l2_n_balls,
)

from new_foolbox import Model, Misclassification, TargetedMisclassification
from new_foolbox.devutils import atleast_kd, flatten
from new_foolbox.distances import l1, linf, l2, l0, LpDistance
...
class FMNAttackLp(MinimizationAttack, ABC):
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        min_, max_ = model.bounds()[0], model.bounds()[1]
        rows = range(N)
