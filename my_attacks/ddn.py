...
class DecoupledDirectionNormL2Attack(Attack):
    ...
    def __call__(
        ...
        # print(a.__dict__)
        # print("a.image shape", a.unperturbed.shape)
        ...
        for i in range(steps):
            ...
            # #FIXME
            # print("l2 dist", (np.sum((perturbation/255.0) ** 2))**0.5)
            # # print("adv", a._Adversarial__best_adversarial_output)
            # if a._Adversarial__best_adversarial is not None:
            #     print("adv", (np.sum((a._Adversarial__best_adversarial/255.0 - unperturbed/255.0) ** 2))**0.5)
