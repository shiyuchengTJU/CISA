...
class IterativeProjectedGradientBaseAttack(Attack):
    ...
    def _run_one(self, a, epsilon, stepsize, iterations,
        ...
        delta = 0
        shit = 1  #  i.e. epsilon in the decoupled attack
        last_is_adversarial = False    #if adversarial example generated last step is adversarial
        gamma = 0.05
        ...
        for _ in range(iterations):
            ...
            delta += stepsize * gradient/gradient_norm

            if last_is_adversarial:
                shit = (1 - gamma) * shit
            else:
                shit = (1 + gamma) * shit
            ...
            x = x + shit*delta/np.sqrt(np.sum(np.square(delta)))
            ...
            last_is_adversarial = is_adversarial
