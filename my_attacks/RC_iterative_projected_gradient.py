...
class IterativeProjectedGradientBaseAttack(Attack):
    ...
    def _run_one(self, a, epsilon, stepsize, iterations,
        ...
        for _ in range(iterations):
            gradient_down = self._gradient(a, x, class_, strict=strict)
            gradient_up   = self._gradient(a, x_up, class_, strict=strict)
            ...
            if go_up_flag:
                gradient_up = -gradient_up
                x_up = x_up + stepsize * gradient_up
            else:
                 x_up = x_up + stepsize * gradient_up

            x = x + stepsize * gradient_down
