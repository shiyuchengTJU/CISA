...
class IterativeProjectedGradientBaseAttack(Attack):
    ...
    def _run_one(self, a, epsilon, stepsize, iterations,
        ...
        for _ in range(iterations):
            ...
            gradient = self._gradient(a, avg_x, class_, strict=strict)
            ...
            if a._Adversarial__best_adversarial is not None:
                #FIXME
                # print("best", l2_distance(a._Adversarial__best_adversarial, original))
                a.evolutionary_doc = np.append(a.evolutionary_doc, l2_distance(a._Adversarial__best_adversarial, original))
                # print("a.evolutionary_doc", a.evolutionary_doc)
            else:
            ...
            if is_adversarial:
                ...
                for binary_counter in range(bb_step):
                    ...
                    temp_logits, temp_is_adversarial = a.forward_one(np.round(middle))
                    if a._Adversarial__best_adversarial is not None:
                        #FIXME
                        # print("best", l2_distance(a._Adversarial__best_adversarial, original))
                        a.evolutionary_doc = np.append(a.evolutionary_doc, l2_distance(a._Adversarial__best_adversarial, original))
